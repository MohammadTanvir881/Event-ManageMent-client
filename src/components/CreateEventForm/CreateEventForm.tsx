...
export default function CreateEventForm() {
  ...
  const [formData, setFormData] = useState({
    eventTitle: "",
    authorName: "",
    eventDate: "", // Now stored as string
    eventTime: "10:00",
    eventLocation: "",
    eventDescription: "",
    attendeeCount: 0,
    authorEmail: "", // Added authorEmail property
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    formData.authorEmail = user?.userEmail; // Add author email from user context
    ...
    try {
      ...
      if (res.success) {
        ...
        setFormData({
          ...
          eventDescription: "",
          attendeeCount: 0,
          authorEmail: "", // Reset authorEmail as well
        });
      } else {
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={handleChange}
                    placeholder="A gathering of tech enthusiasts, developers, and startups..."
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    placeholder="JUST Auditorium, Jashore"
                    className="bg-slate-700/50 border-slate-600 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-white placeholder-slate-400 h-12"
                    required
                  />
                </div>
